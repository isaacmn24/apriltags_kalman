...
echo_and_run cd "/home/isaac/Downloads/apriltags_kalman/ros_workspace/src/rotors_simulator/rqt_rotors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/isaac/Downloads/apriltags_kalman/ros_workspace/src/rotors_simulator/rqt_rotors/setup.py" \
     \
    build --build-base "/home/isaac/Downloads/apriltags_kalman/ros_workspace/build/rotors_simulator/rqt_rotors" \
    install \
    --root="${DESTDIR-/}" \
